                        ...
                        match xs with 
                         ...
                         | [Sum (s); Prod (p)] -> (
                                                   match p with 
                                                    ...
                                                    | _ -> (*Printf.printf "Expression: %s\n" (Printing.print_num_type expr);*) failwith "[Invalid argument] transform_constraint_smt2_rec: unsupported arithmetic expression"
                                                  )
                         | [Prod (p); Sum (s)] -> (
                                                   match p with 
                                                    | [Num (n); Num (m)] -> (
...
let transform_constraint_smt2 cons =
    (*let (cons_left, cons_right) = cons in
    Printf.printf "Constraint: %s\n\n" (Printing.print_constraint_n (Constraint (LessEq (cons_left, cons_right))));*)
    match cons with
        | (Sum (s), Var (x)) -> (
                                 match (transform_constraint_smt2_rec (Sum (s)) None None) with
                                    | (Some (Sum (ss)), Some (ns)) -> (
...
let rec op_to_simplex_format_inc operator varlist varcount = 
    (*Printf.printf "operator: %s\n\n" (Printing.print_num_type operator);*)
    match operator with
        | Var (x) -> (
                      match (is_in_varlist varlist x) with 
                                                        ...
                                                        | (Var (x), Num (n)) -> 
                                                                           (
                                                                            ...
                                                                            | (-1, true) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                                                                                                                               ...
                                                                                                                                                                               (cs @ [(c, v, d, dl)])
                                                                                                                                                                               i_map                        
                                                                            | (-1, false) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                                                                                                                                                       (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))])
                                                                                                                                                                               (cs @ [(c, v, d, dl)])    
                                                                                                                                                                               i_map              
                                                                            | (m, true) -> to_simplex_format_inc (Assignment (xs)) varlist varcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m))), 
                                                                                                                                                ...
                                                                                                                                                (cs @ [(c, v, d, dl)])       
                                                                                                                                                i_map
                                                                            | (m, false) -> to_simplex_format_inc (Assignment (xs)) varlist varcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m))), 
                                                                                                                                                                        (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))])
                                                                                                                                                 (cs @ [(c, v, d, dl)])  
                                                                                                                                                 i_map
                                                                           )
                                                        | (Num (n), Var (x)) ->
                                                                           (
                                                                            ...
                                                                            | (-1, true) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                                                                                                                               ...
                                                                                                                                                                               (cs @ [(c, v, d, dl)]) 
                                                                                                                                                                               i_map
                                                                            | (-1, false) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))),
                                                                                                                                                                                                        (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))])
                                                                                                                                                                                (cs @ [(c, v, d, dl)])
                                                                                                                                                                                i_map
                                                                            | (m, true) -> to_simplex_format_inc (Assignment (xs)) varlist varcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m))), 
                                                                                                                                                ...
                                                                                                                                                (cs @ [(c, v, d, dl)])
                                                                                                                                                i_map
                                                                            | (m, false) -> to_simplex_format_inc (Assignment (xs)) varlist varcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m))), 
                                                                                                                                                                         (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))])
                                                                                                                                                 (cs @ [(c, v, d, dl)])
                                                                                                                                                 i_map
                                                                           )
                                                                              ...
                                                                              | -1 -> (
                                                                                       match ((is_in_varlist varlist y), v) with 
                                                                                        | (-1, true) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)] @ [(y, varcount + 2)]) (varcount + 2) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                 (cs @ [(c, v, d, dl)])
                                                                                                                                                                                                                 i_map
                                                                                        | (-1, false) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)] @ [(y, varcount + 2)]) (varcount + 2) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GTPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                                                                                                                                                                                           (Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 2))))))])
                                                                                                                                                                                                                 (cs @ [(c, v, d, dl)])
                                                                                                                                                                                                                 i_map
                                                                                        | (m, true) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                                                                                                                                          ...
                                                                                                                                                                                          (cs @ [(c, v, d, dl)]) 
                                                                                                                                                                                          i_map
                                                                                        | (m, false) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GTPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                                                                                                                                                                    (Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m)))))])
                                                                                                                                                                                          (cs @ [(c, v, d, dl)]) 
                                                                                                                                                                                          i_map
                                                                                      )   
                                                                              | m1 -> (
                                                                                       match ((is_in_varlist varlist y), v) with 
                                                                                        | (-1, true) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(y, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m1))), 
                                                                                                                                                                                           ...
                                                                                                                                                                                           (cs @ [(c, v, d, dl)]) 
                                                                                                                                                                                           i_map
                                                                                        | (-1, false) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(y, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GTPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m1))), 
                                                                                                                                                                                                                     (Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1))))))])
                                                                                                                                                                                           (cs @ [(c, v, d, dl)]) 
                                                                                                                                                                                           i_map
                                                                                        | (m2, true) -> to_simplex_format_inc (Assignment (xs)) varlist varcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m1))), 
                                                                                                                                                             ...
                                                                                                                                                             (cs @ [(c, v, d, dl)])
                                                                                                                                                             i_map
                                                                                        | (m2, false) -> to_simplex_format_inc (Assignment (xs)) varlist varcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GTPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m1))), 
                                                                                                                                                                                       (Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m2)))))])
                                                                                                                                                             (cs @ [(c, v, d, dl)])
                                                                                                                                                             i_map
                                                                                      )
                                                                            ...
                                                                            | (sums, Num (n)) -> (
                                                                                                ...
                                                                                                | (s_lp, newlist, newcount) -> 
                                                                                                                (
                                                                                                                    match v with 
                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                )
                                                                                                )
                                                                            | (sums, Div (Num (n1), Num (n2))) -> (
                                                                                                                    match (op_to_simplex_format_inc sums varlist varcount) with
                                                                                                                    | (s_lp, newlist, newcount) -> 
                                                                                                                                    (
                                                                                                                                        match v with 
                                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n1) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n1)) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                  )
                                                                        )
                                                        | (Var (x), Sum (s)) ->
                                                                            ...
                                                                            | (Num (n), sums) -> (
                                                                                            ...
                                                                                            | (s_lp, newlist, newcount) -> 
                                                                                                               (
                                                                                                                match v with 
                                                                                                                | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                               )
                                                                                                )
                                                                            | (Div (Num (n1), Num (n2)), sums) -> (
                                                                                                                match (op_to_simplex_format_inc sums varlist varcount) with
                                                                                                                | (s_lp, newlist, newcount) -> 
                                                                                                                                (
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n1) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n1)) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                )
                                                                                                                  )
                                                                        )
                                                        | (Sum (s), Num (n)) ->
                                                                            ...
                                                                            | (sums, Num (m)) -> (
                                                                                            ...
                                                                                            | (s_lp, newlist, newcount) -> 
                                                                                                               (
                                                                                                                ...
                                                                                                                | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                               )
                                                                                                )
                                                                            | (sums, Div (Num (m1), Num (m2))) -> (
                                                                                                                match (op_to_simplex_format_inc sums varlist varcount) with
                                                                                                                | (s_lp, newlist, newcount) -> 
                                                                                                                                (
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m1) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m1)) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                )
                                                                                                                    )
                                                                        )
                                                        | (Num (n), Sum (s)) ->
                                                                            ...
                                                                            | (Num (m), sums) -> (
                                                                                            ...
                                                                                            | (s_lp, newlist, newcount) -> 
                                                                                                               (
                                                                                                                ...
                                                                                                                | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                               )
                                                                                                )
                                                                            | (Div (Num (m1), Num (m2)), sums) -> (
                                                                                                                match (op_to_simplex_format_inc sums varlist varcount) with
                                                                                                                | (s_lp, newlist, newcount) -> 
                                                                                                                                (
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m1) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m1)) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                )
                                                                                                                )
                                                                        )
                                                        | (Prod (p), Var (x)) ->
                                                                             ...
                                                                             | (prod, Num (n)) -> (
                                                                                                    ...
                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                    (
                                                                                                                        match v with 
                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                    )
                                                                                                  )
                                                                             | (prod, Div (Num (n1), Num (n2))) -> (
                                                                                                                    match (op_to_simplex_format_inc prod varlist varcount) with
                                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                                    (
                                                                                                                                        match v with 
                                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n1) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n1)) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                   )
                                                                            (*match (op_to_simplex_format_inc (Prod (p)) varlist varcount) with
                                                                                | (p_lp, newlist, newcount) -> 
                                                                             ...
                                                                             | (Num (n), prod) -> (
                                                                                                    ...
                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                    (
                                                                                                                        match v with 
                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                    )
                                                                                                  )
                                                                             | (Div (Num (n1), Num (n2)), prod) -> (
                                                                                                                    match (op_to_simplex_format_inc prod varlist varcount) with
                                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                                    ...
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n1) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n1)) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                   )
                                                                            (*match (op_to_simplex_format_inc (Prod (p)) varlist varcount) with
                                                                                | (p_lp, newlist, newcount) -> 
                                                                            ...
                                                                            match (transform_constraint_smt2 (Prod (p), Num (n))) with 
                                                                             | (prod, Num (m)) -> (
                                                                                                    ...
                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                    (
                                                                                                                        match v with 
                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                    )
                                                                                                  )
                                                                             | (prod, Div (Num (m1), Num (m2))) -> (
                                                                                                                    match (op_to_simplex_format_inc prod varlist varcount) with
                                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                                    (
                                                                                                                                        match v with 
                                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m1) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m1)) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                   )
                                                                            (*
                                                                            match (op_to_simplex_format_inc (Prod (p)) varlist varcount) with
                                                                            ...
                                                                            match (transform_constraint_smt2 (Num (n), Prod (p))) with 
                                                                             | (Num (m), prod) -> (
                                                                                                    ...
                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                    (
                                                                                                                        match v with 
                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                    )
                                                                                                  )
                                                                             | (Div (Num (m1), Num (m2)), prod) -> (
                                                                                                                    match (op_to_simplex_format_inc prod varlist varcount) with
                                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                                    (
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m1) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m1)) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                   )
                                                                            (*match (op_to_simplex_format_inc (Prod (p)) varlist varcount) with
                                                                                | (p_lp, newlist, newcount) -> (
                                                     ...
                                                     match (l, r) with 
                                                        ...
                                                        | (Var (x), Var (y)) ->
                                                                             ...
                                                                             match (is_in_varlist varlist x) with 
                                                                              | -1 -> (
                                                                                       match ((is_in_varlist varlist y), v) with 
                                                                                        | (-1, true) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)] @ [(y, varcount + 2)]) (varcount + 2) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LTPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                                                                                                                                                                                           (Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 2))))))])
                                                                                                                                                                                                                 (cs @ [(c, v, d, dl)])
                                                                                                                                                                                                                 i_map
                                                                                        (*| (_, false) -> 
                                                                                                         ...
                                                                                                         *)
                                                                                        | (-1, false) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)] @ [(y, varcount + 2)]) (varcount + 2) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                                                                                                                                                                                           (Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 2))))))])
                                                                                                                                                                                                                 (cs @ [(c, v, d, dl)])
                                                                                                                                                                                                                 i_map
                                                                                        | (m, true) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(x, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LTPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1)))), 
                                                                              ...
                                                                              | m1 -> (
                                                                                       match ((is_in_varlist varlist y), v) with 
                                                                                        | (-1, true) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(y, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LTPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m1))), 
                                                                                                                                                                                                                     (Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1))))))])
                                                                                                                                                                                           (cs @ [(c, v, d, dl)]) 
                                                                                                                                                                                           i_map
                                                                                        (*| (_, false) -> ( 
                                                                                        ...
                                                                                        | (-1, false) -> to_simplex_format_inc (Assignment (xs)) (varlist @ [(y, varcount + 1)]) (varcount + 1) (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m1))), 
                                                                                                                                                                                                                     (Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int (varcount + 1))))))])
                                                                                                                                                                                           (cs @ [(c, v, d, dl)]) 
                                                                                                                                                                                           i_map
                                                                                        | (m2, true) -> to_simplex_format_inc (Assignment (xs)) varlist varcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LTPP ((Simplex_inc.lp_monom (Simplex_inc.rat_of_int_pair (big_int_of_int 1) (big_int_of_int 1)) (Simplex_inc.nat_of_integer (big_int_of_int m1))), 
                                                                         ...
                                                                         match (transform_constraint_smt2 (Sum (s), Var (x))) with
                                                                            | (sums, Num (n)) -> (
                                                                                                ...
                                                                                                | (s_lp, newlist, newcount) -> 
                                                                                                                (
                                                                                                                    match v with 
                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                )
                                                                                                )
                                                                            | (sums, Div (Num (n1), Num (n2))) -> (
                                                                                                                    match (op_to_simplex_format_inc sums varlist varcount) with
                                                                                                                    | (s_lp, newlist, newcount) -> 
                                                                                                                                    (
                                                                                                                                        match v with 
                                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n1) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n1)) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                  )
                                                                        )
                                                        | (Var (x), Sum (s)) ->
                                                                         ...
                                                                         match (transform_constraint_smt2 (Var (x), Sum (s))) with
                                                                            | (Num (n), sums) -> (
                                                                                            ...
                                                                                            | (s_lp, newlist, newcount) -> 
                                                                                                               (
                                                                                                                match v with 
                                                                                                                | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                            ...
                                                                            | (Div (Num (n1), Num (n2)), sums) -> (
                                                                                                                ...
                                                                                                                | (s_lp, newlist, newcount) -> 
                                                                                                                                (
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n1) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n1)) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                )
                                                                                                                  )
                                                                        )
                                                        | (Sum (s), Num (n)) ->
                                                                         ...
                                                                         match (transform_constraint_smt2 (Sum (s), Num (n))) with
                                                                            | (sums, Num (m)) -> (
                                                                                            ...
                                                                                            | (s_lp, newlist, newcount) -> 
                                                                                                               (
                                                                                                                match v with 
                                                                                                                | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                               )
                                                                                                )
                                                                            | (sums, Div (Num (m1), Num (m2))) -> (
                                                                                                                match (op_to_simplex_format_inc sums varlist varcount) with
                                                                                                                | (s_lp, newlist, newcount) -> 
                                                                                                                                (
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m1) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m1)) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                )
                                                                                                                    )
                                                                        )
                                                        | (Num (n), Sum (s)) ->
                                                                         ...
                                                                         match (transform_constraint_smt2 (Num (n), Sum (s))) with
                                                                            | (Num (m), sums) -> (
                                                                                            ...
                                                                                            | (s_lp, newlist, newcount) -> 
                                                                                                               (
                                                                                                                match v with 
                                                                                                                | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                            ...
                                                                            | (Div (Num (m1), Num (m2)), sums) -> (
                                                                                                                ...
                                                                                                                | (s_lp, newlist, newcount) -> 
                                                                                                                                (
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GT (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m1) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (s_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m1)) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                )
                                                                                                                )
                                                                        )
                                                        | (Prod (p), Var (x)) ->
                                                                            ...
                                                                            match (transform_constraint_smt2 (Prod (p), Var (x))) with 
                                                                             | (prod, Num (n)) -> (
                                                                                                    ...
                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                    (
                                                                                                                        match v with 
                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                    )
                                                                                                  )
                                                                             | (prod, Div (Num (n1), Num (n2))) -> (
                                                                                                                    match (op_to_simplex_format_inc prod varlist varcount) with
                                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                                    (
                                                                                                                                        match v with 
                                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n1) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n1)) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                   )
                                                                            (*match (op_to_simplex_format_inc (Prod (p)) varlist varcount) with
                                                                                | (p_lp, newlist, newcount) -> 
                                                                            ...
                                                                            match (transform_constraint_smt2 (Var (x), Prod (p))) with 
                                                                             | (Num (n), prod) -> (
                                                                                                    ...
                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                    (
                                                                                                                        match v with 
                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                             ...
                                                                             | (Div (Num (n1), Num (n2)), prod) -> (
                                                                                                                    ...
                                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                                    (
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int n1) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (n1)) (big_int_of_int n2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                   )
                                                                            (*match (op_to_simplex_format_inc (Prod (p)) varlist varcount) with
                                                                                | (p_lp, newlist, newcount) -> 
                                                                            ...
                                                                            match (transform_constraint_smt2 (Prod (p), Num (n))) with 
                                                                             | (prod, Num (m)) -> (
                                                                                                    ...
                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                    (
                                                                                                                        match v with 
                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                    )
                                                                                                  )
                                                                             | (prod, Div (Num (m1), Num (m2))) -> (
                                                                                                                    match (op_to_simplex_format_inc prod varlist varcount) with
                                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                                    (
                                                                                                                                        match v with 
                                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.LT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m1) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.GEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m1)) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                   )
                                                                            (*
                                                                            match (op_to_simplex_format_inc (Prod (p)) varlist varcount) with
                                                                            ...
                                                                            match (transform_constraint_smt2 (Num (n), Prod (p))) with 
                                                                             | (Num (m), prod) -> (
                                                                                                    ...
                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                    (
                                                                                                                        match v with 
                                                                                                                        | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                        | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m)) (big_int_of_int 1))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                    )
                                                                                                  )
                                                                             | (Div (Num (m1), Num (m2)), prod) -> (
                                                                                                                    match (op_to_simplex_format_inc prod varlist varcount) with
                                                                                                                    | (p_lp, newlist, newcount) -> 
                                                                                                                                    (
                                                                                                                                    match v with 
                                                                                                                                    | true -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find (Printing.print_constraint_n c) i_map)), Simplex_inc.GT (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int m1) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    | false -> to_simplex_format_inc (Assignment (xs)) newlist newcount (result @ [(Simplex_inc.nat_of_integer (big_int_of_int (Tseitin.Index_Map.find ("-" ^ Printing.print_constraint_n c) i_map)), Simplex_inc.LEQ (p_lp, (Simplex_inc.rat_of_int_pair (big_int_of_int (m1)) (big_int_of_int m2))))]) (cs @ [(c, v, d, dl)]) i_map
                                                                                                                                    )
                                                                                                                   )
                                                                            (*match (op_to_simplex_format_inc (Prod (p)) varlist varcount) with
                                                                                | (p_lp, newlist, newcount) -> (
