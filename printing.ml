...
let print_less_equal le =
    match le with
        ...
        | Less (x, y) -> "Less (" ^ (print_num_type x) ^ ", " ^ (print_num_type y) ^ ")"
...
let rec fmaplist_to_string_inc l =
    match l with
        | [] -> ""
        | ((Simplex_Inc.Nat n), (Simplex_Inc.Frct (x, y))) :: xs -> " + (" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y))) ^ ") * " ^ (string_of_int (Z.to_int n)) ^ (fmaplist_to_string_inc xs);;
...
let rec print_simplex_constraints_inc_rec constraints = 
    match constraints with
        ...
        | (x, Simplex_Inc.LEQ ((Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n), (Simplex_Inc.Frct (x1, y1))) :: ns))), (Simplex_Inc.Frct (x2, y2)))) :: cs -> 
                        "(" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_nat x))) ^ ") ((" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x1))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y1))) ^ ") * " ^ (string_of_int (Z.to_int n)) ^ fmaplist_to_string_inc ns ^ " <= (" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x2))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y2))) ^ "))\n" ^ print_simplex_constraints_inc_rec cs
        | (x, Simplex_Inc.GEQ ((Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n), (Simplex_Inc.Frct (x1, y1))) :: ns))), (Simplex_Inc.Frct (x2, y2)))) :: cs ->
                        "(" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_nat x))) ^ ") ((" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x1))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y1))) ^ ") * " ^ (string_of_int (Z.to_int n)) ^ fmaplist_to_string_inc ns ^ " >= (" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x2))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y2))) ^ "))\n" ^ print_simplex_constraints_inc_rec cs
        | (x, Simplex_Inc.LT ((Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n), (Simplex_Inc.Frct (x1, y1))) :: ns))), (Simplex_Inc.Frct (x2, y2)))) :: cs -> 
                        "(" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_nat x))) ^ ") ((" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x1))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y1))) ^ ") * " ^ (string_of_int (Z.to_int n)) ^ fmaplist_to_string_inc ns ^ " < (" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x2))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y2))) ^ "))\n" ^ print_simplex_constraints_inc_rec cs
        | (x, Simplex_Inc.GT ((Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n), (Simplex_Inc.Frct (x1, y1))) :: ns))), (Simplex_Inc.Frct (x2, y2)))) :: cs ->
                        "(" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_nat x))) ^ ") ((" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x1))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y1))) ^ ") * " ^ (string_of_int (Z.to_int n)) ^ fmaplist_to_string_inc ns ^ " > (" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x2))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y2))) ^ "))\n" ^ print_simplex_constraints_inc_rec cs
        | (x, Simplex_Inc.LEQPP ((Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n1), (Simplex_Inc.Frct (x1, y1))) :: n1s))), (Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n2), (Simplex_Inc.Frct (x2, y2))) :: n2s))))) :: cs ->
                        "(" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_nat x))) ^ ") ((" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x1))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y1))) ^ ") * " ^ (string_of_int (Z.to_int n1)) ^ fmaplist_to_string_inc n1s ^ " <= (" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x2))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y2))) ^ ") * " ^ (string_of_int (Z.to_int n2)) ^ fmaplist_to_string_inc n2s ^ ")\n" ^ print_simplex_constraints_inc_rec cs
        | (x, Simplex_Inc.LTPP ((Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n1), (Simplex_Inc.Frct (x1, y1))) :: n1s))), (Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n2), (Simplex_Inc.Frct (x2, y2))) :: n2s))))) :: cs ->
                        "(" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_nat x))) ^ ") ((" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x1))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y1))) ^ ") * " ^ (string_of_int (Z.to_int n1)) ^ fmaplist_to_string_inc n1s ^ " < (" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x2))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y2))) ^ ") * " ^ (string_of_int (Z.to_int n2)) ^ fmaplist_to_string_inc n2s ^ ")\n" ^ print_simplex_constraints_inc_rec cs
        | (x, Simplex_Inc.GTPP ((Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n1), (Simplex_Inc.Frct (x1, y1))) :: n1s))), (Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n2), (Simplex_Inc.Frct (x2, y2))) :: n2s))))) :: cs -> 
                        "(" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_nat x))) ^ ") ((" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x1))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y1))) ^ ") * " ^ (string_of_int (Z.to_int n1)) ^ fmaplist_to_string_inc n1s ^ " > (" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x2))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y2))) ^ ") * " ^ (string_of_int (Z.to_int n2)) ^ fmaplist_to_string_inc n2s ^ ")\n" ^ print_simplex_constraints_inc_rec cs
        | (x, Simplex_Inc.GEQPP ((Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n1), (Simplex_Inc.Frct (x1, y1))) :: n1s))), (Simplex_Inc.LinearPoly (Simplex_Inc.Fmap_of_list (((Simplex_Inc.Nat n2), (Simplex_Inc.Frct (x2, y2))) :: n2s))))) :: cs -> 
                        "(" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_nat x))) ^ ") ((" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x1))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y1))) ^ ") * " ^ (string_of_int (Z.to_int n1)) ^ fmaplist_to_string_inc n1s ^ " >= (" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int x2))) ^ "/" ^ (string_of_int (Z.to_int (Simplex_Inc.integer_of_int y2))) ^ ") * " ^ (string_of_int (Z.to_int n2)) ^ fmaplist_to_string_inc n2s ^ ")\n" ^ print_simplex_constraints_inc_rec cs
