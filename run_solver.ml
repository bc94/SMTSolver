...
let transform_and_run_ceta formula = 
        ...
        match (Simplex_Validity_Checker.check_well_formed_IA_formula_string_vars f) with
                | true -> ( 
                           match (Simplex_Validity_Checker.check_valid_IA_formula_string_vars f) with
